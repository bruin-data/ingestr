...
def tiktok_source(start_date: str,end_date: str, access_token:str)->Sequence[DltResource]:
    ...
    def campaigns(
        ...
        yield from titkok_api.fetch_campaigns(start_time=start_time, end_time=end_date, advertiser_id="1")
