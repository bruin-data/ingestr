...
func TestOracleDestinationCDCMergeDoesNotRegressTargetLSN(t *testing.T) {
	...
	setup := []string{
		...
		SELECT 1 FROM DUAL`, targetTable, targetTable, targetTable, targetTable, targetTable, targetTable, targetTable),
		fmt.Sprintf(`INSERT ALL
		...
		SELECT 1 FROM DUAL`, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable, stagingTable),
	}
