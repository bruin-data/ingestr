...
func (d *ClickHouseDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *ClickHouseDestination) SupportsColumnTypeChanges() bool {
