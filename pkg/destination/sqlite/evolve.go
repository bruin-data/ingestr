...
func (d *SQLiteDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *SQLiteDestination) SupportsColumnTypeChanges() bool {
