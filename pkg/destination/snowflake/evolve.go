...
func (d *SnowflakeDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *SnowflakeDestination) SupportsColumnTypeChanges() bool {
