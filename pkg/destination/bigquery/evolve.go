...
func (d *BigQueryDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *BigQueryDestination) SupportsColumnTypeChanges() bool {
