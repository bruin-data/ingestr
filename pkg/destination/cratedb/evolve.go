...
func (d *CrateDBDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *CrateDBDestination) SupportsColumnTypeChanges() bool {
