...
func (d *SynapseDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *SynapseDestination) SupportsColumnTypeChanges() bool {
