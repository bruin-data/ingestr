...
func (d *CassandraDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *CassandraDestination) SupportsColumnTypeChanges() bool {
