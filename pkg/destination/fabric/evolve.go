...
func (d *FabricDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *FabricDestination) SupportsColumnTypeChanges() bool {
