...
func (d *RedshiftDestination) ApplySchemaEvolution(ctx context.Context, table string, comparison *schemaevolution.SchemaComparison) ([]string, error) {
...
func (d *RedshiftDestination) SupportsColumnTypeChanges() bool {
