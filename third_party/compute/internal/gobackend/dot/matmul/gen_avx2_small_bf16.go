...
// - Base source file (edit this one): avx2_small.go
...
//
//alt:f32 func avx2SmallFloat32Parallel(
func avx2SmallBFloat16Parallel( //alt:bf16
	...
	if maxWorkers <= 1 || batchSize <= 1 {
		if layout == dot.LayoutNonTransposed {
			//alt:f32 avx2SmallFloat32(lhs, rhs, 0, batchSize, lhsCrossSize, rhsCrossSize, contractingSize, output)
			avx2SmallBFloat16(lhs, rhs, 0, batchSize, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:bf16
			...
			//alt:f32 avx2SmallFloat32Transposed(lhs, rhs, 0, batchSize, lhsCrossSize, rhsCrossSize, contractingSize, output)
			avx2SmallBFloat16Transposed(lhs, rhs, 0, batchSize, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:bf16
	...
	backend.Workers.Saturate(func() {
		for chunk := range work {
			if layout == dot.LayoutNonTransposed {
				//alt:f32 avx2SmallFloat32(lhs, rhs, chunk.batchIdx, chunk.batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output)
				avx2SmallBFloat16(lhs, rhs, chunk.batchIdx, chunk.batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:bf16
				...
				//alt:f32 avx2SmallFloat32Transposed(lhs, rhs, chunk.batchIdx, chunk.batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output)
				avx2SmallBFloat16Transposed(lhs, rhs, chunk.batchIdx, chunk.batchCount, lhsCrossSize, rhsCrossSize, contractingSize, output) //alt:bf16
...
//
//alt:f32 func avx2SmallFloat32(
func avx2SmallBFloat16( //alt:bf16
	...
	for range batchCount {
		...
		for ; row+3 < lhsCrossSize; row += 4 {
			for k := 0; k < contractingSize; k++ {
				...
				//alt:f32 l0 := archsimd.BroadcastFloat32x8(*(*float32)(unsafe.Pointer(l0_ptr)))
				l0_bf16 := (*(*bfloat16.BFloat16)(unsafe.Pointer(l0_ptr))).Float32() //alt:bf16
				l0 := archsimd.BroadcastFloat32x8(l0_bf16)                           //alt:bf16
				...
				//alt:f32 l1 := archsimd.BroadcastFloat32x8(*(*float32)(unsafe.Pointer(l1_ptr)))
				l1_bf16 := (*(*bfloat16.BFloat16)(unsafe.Pointer(l1_ptr))).Float32() //alt:bf16
				l1 := archsimd.BroadcastFloat32x8(l1_bf16)                           //alt:bf16
				...
				//alt:f32 l2 := archsimd.BroadcastFloat32x8(*(*float32)(unsafe.Pointer(l2_ptr)))
				l2_bf16 := (*(*bfloat16.BFloat16)(unsafe.Pointer(l2_ptr))).Float32() //alt:bf16
				l2 := archsimd.BroadcastFloat32x8(l2_bf16)                           //alt:bf16
				...
				//alt:f32 l3 := archsimd.BroadcastFloat32x8(*(*float32)(unsafe.Pointer(l3_ptr)))
				l3_bf16 := (*(*bfloat16.BFloat16)(unsafe.Pointer(l3_ptr))).Float32() //alt:bf16
				l3 := archsimd.BroadcastFloat32x8(l3_bf16)                           //alt:bf16
		...
		for ; row < lhsCrossSize; row++ {
			for k := 0; k < contractingSize; k++ {
				...
				//alt:f32 l0 := archsimd.BroadcastFloat32x8(*(*float32)(unsafe.Pointer(l_ptr)))
				l0 := archsimd.BroadcastFloat32x8((*(*bfloat16.BFloat16)(unsafe.Pointer(l_ptr))).Float32()) //alt:bf16
...
//
//alt:f32 func avx2SmallFloat32Transposed(
func avx2SmallBFloat16Transposed( //alt:bf16
	...
	for range batchCount {
		for row := 0; row < lhsCrossSize; row++ {
			for col := 0; col < rhsCrossSize; col++ {
				...
				k := 0
				//alt:f32 const vecWidth = 8
				const vecWidth = 16 //alt:bf16
