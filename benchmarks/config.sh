...
CLICKHOUSE_DST_HOST="localhost"
CLICKHOUSE_DST_NATIVE_PORT="9001"
CLICKHOUSE_DST_HTTP_PORT="8124"
CLICKHOUSE_DST_USER="bench_user"
CLICKHOUSE_DST_PASS="bench_pass"
CLICKHOUSE_DST_DB="bench_dest"
CLICKHOUSE_DST_URI="clickhouse://${CLICKHOUSE_DST_USER}:${CLICKHOUSE_DST_PASS}@${CLICKHOUSE_DST_HOST}:${CLICKHOUSE_DST_NATIVE_PORT}/${CLICKHOUSE_DST_DB}?http_port=${CLICKHOUSE_DST_HTTP_PORT}&secure=0"
...
SLING_CLICKHOUSE_DST_ENV="CLICKHOUSE_BENCH_DST"
