...
lock-deps:
	@uv pip compile requirements.in --quiet -o requirements.txt --no-emit-package requests
	@uv pip compile requirements.in --quiet -o requirements_arm64.txt --python-platform aarch64-unknown-linux-gnu --no-emit-package requests
